...
class ContainerDwellTimeAnalysisReport(AbstractReportWithMatplotlib):
    ...
    @staticmethod
    def _get_vehicle_representation(vehicle_type: Any) -> str:
        if vehicle_type is None or vehicle_type == "all":
            return "all"
    ...
    def _get_storage_requirement_representation(storage_requirement: Any) -> str:
        if storage_requirement is None or storage_requirement == "all":
            return "all"
