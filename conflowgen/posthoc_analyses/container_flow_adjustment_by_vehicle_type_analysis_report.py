...
from conflowgen.posthoc_analyses.abstract_posthoc_analysis_report import AbstractPosthocAnalysisReportWithPlotly
...
class ContainerFlowAdjustmentByVehicleTypeAnalysisReport(AbstractPosthocAnalysisReportWithPlotly):
    """
