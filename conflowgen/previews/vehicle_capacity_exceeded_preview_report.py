...
class VehicleCapacityExceededPreviewReport(AbstractPreviewReportWithMatplotlib):
    """
    ...
    <notebooks/previews.html#InboundAndOutboundVehicleCapacityPreviewReport>`_.
    """
